...
var entryCommon = (bind, lib) => {
  ...
  patch(lib.Node.prototype, 'setMeasureFunc', function(original, measureFunc) {
    ...
    // .height properties
    if (measureFunc) {
      return original.call(this, lib.MeasureCallback.implement({
        measure: (...args) => Size.fromJS(measureFunc(...args)),
      }));
    } else {
  ...
  patch(lib.Node.prototype, 'setDirtiedFunc', function(original, dirtiedFunc) {
    ...
    if (dirtiedFunc) {
      return original.call(this, lib.DirtiedCallback.implement({
        dirtied: dirtiedFunc,
      }));
    } else {
